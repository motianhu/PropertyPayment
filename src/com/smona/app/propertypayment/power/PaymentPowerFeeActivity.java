...
public class PaymentPowerFeeActivity extends PaymentBaseActivity {
    ...
    private static final String TAG = PaymentPowerFeeActivity.class
            .getSimpleName();
    ...
    private void initSelectFee() {
        mSelectFee = (SelectFeeView) findViewById(R.id.select_fee);
    ...
    private void clickNextStep() {
        ...
        gotoSubActivity(mFeeDan, PaymentPowerConfirmActivity.class);
    }
}
